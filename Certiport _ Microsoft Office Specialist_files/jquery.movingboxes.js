...
(function($){
	...
	$.movingBoxes.defaultOptions = {
		...
		width        : 590,       // overall width of movingBoxes
		panelWidth   : 0.3,       // current panel width adjusted to 50% of overall width
		reducedSize  : 0.9,       // non-current panel size: 90% of panel size
		...
		disabled     : 'enabled',// class added to arrows that are disabled (left arrow when on first panel, right arrow on last panel)
